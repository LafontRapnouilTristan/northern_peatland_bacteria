...
relab_prev_genus <- 
  ...
  scale_y_log10(limits=c(.01,100),breaks=c(.01,.1,1,10))+
...
df_sites_low_ubi%>%
  ...
  distinct()%>%
  ggplot(aes(x=Country,color=low_ubi))+
...
my_colors <- as.vector(paletteer::paletteer_d("rcartocolor::Antique"))
names(my_colors) <- levels(class4tree_enz$tree_class)
...
ggsave("figures_and_results/figures/fig2/relab_prev_cor.png",relab_prev_genus,height = 6,width = 10)
...
ggsave("figures_and_results/figures/fig6/GDM_pred.png",gdm_plot_pred,height = 4,width = 8)
ggsave("figures_and_results/figures/fig6/GDM_spline.png",gdm_plot_var,height = 4,width = 6)
